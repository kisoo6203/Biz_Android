package com.kisoo.chatt.Adapter;
...
/*
    ...
    RecyclerView.에 데이터를 표현하고자 할때 사용하는 Helper 클래스
...
public class ChattAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        /*
            ...
            여기에서는 RecyclerView 내부에 각각의 데이터 아이템을 그릴
            도구로 사용이 된다
            이러한 layout은 setContentView()를 사용하지 않고
            layoutInflater.inflate() 한수를 사용하여 만든다
         */
        View item_layout =
    ...
    public static class ChattViewHolder extends RecyclerView.ViewHolder{
        ...
        // 각 데이터를 표현하기 위한 view 객체(두개의 TextView)를 초기화 하는 method
